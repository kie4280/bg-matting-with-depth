...
# Conversion loop
with torch.no_grad():
    for (true_pha, true_fgr), true_bgr in tqdm(dataloader_valid):
...
with open(NAME, 'w+') as f:
    f.write("MSE alpha:" + str(float(MSE_pha_loss.cpu())) + "\n")
    f.write("SAD_loss:" + str(float(SAD_loss.cpu())) + "\n")
    f.write("MSE fgr:" +  str(float(MSE_fgr_loss)) + "\n")
